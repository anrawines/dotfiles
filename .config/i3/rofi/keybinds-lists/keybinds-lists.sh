...
keybindings=$(awk '
    ...
    { last="" } 
    /^#/ { last=substr($0, 3) }' ~/.config/i3/sxhkd/sxhkdrc)
...
selected=$(echo "$formatted_keybindings" | rofi -dmenu -i -p "Keybindings" -line-padding 4 -hide-scrollbar -theme ~/.config/i3/rofi/keybinds-lists/keybinds.rasi)
